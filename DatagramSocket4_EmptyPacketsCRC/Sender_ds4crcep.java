...
/**
 * SENDER FOR DATAGRAM SOCKET 4 - CRC WITH ADDING EMPTY PACKETS WHERE THERE 
 * IS CORRUPTION
 * 
 * @authors: JV & CC
 */
...
public class Sender_ds4crcep implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            Logger.getLogger(Sender_ds4crcep.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
