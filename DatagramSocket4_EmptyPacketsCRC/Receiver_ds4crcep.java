...
/**
 * RECEIVER FOR DATAGRAM SOCKET 4 - CRC WITH ADDING EMPTY PACKETS WHERE THERE 
 * IS CORRUPTION
 * 
 * @authors: JV & CC
 */
...
public class Receiver_ds4crcep implements Runnable {
        ...
        try {
            ...
            while (running == true) {
                try {
                    ...
                    /**
                     * CRC Calculations Play previous packet audio if packet is
                     * corrupt.
                     */
            ...
            Logger.getLogger(Receiver_ds4crcep.class.getName()).log(Level.SEVERE, null, ex);
        }
