package DatagramSocket2_Interleaved_EmptyPackets;
/**
 * RECEIVER FOR DATAGRAM SOCKET 2 - INTERLEAVED PLACING EMPTY PACKETS WHERE 
 * THERE IS A LOSS
 * 
 * @authors: JV & CC
 */
...
public class Receiver_ds3iep implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            Logger.getLogger(Receiver_ds3iep.class.getName()).log(Level.SEVERE, null, ex);
