...
/**
 * SENDER FOR DATAGRAM SOCKET 3 - INTERLEAVED
 *
 * @authors: JV & CC
 */
...
public class Sender_ds3i implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            Logger.getLogger(Sender_ds3i.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
